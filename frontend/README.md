...
Backend: POST to http://127.0.0.1:8000/repositories/ingest before research, then POST to http://127.0.0.1:8000/rag or http://127.0.0.1:8000/research. Ingestion request fields: repository_address string, accepting a local path or public GitHub URL. Direct RAG request fields: question string, mode one of auto/locate/flow/change, retrieval_mode one of dense/sparse/hybrid, limit 1-20, optional repository_path. Agentic RAG uses retrieval_limit instead of limit. API base URL must be editable and default to http://127.0.0.1:8000.
