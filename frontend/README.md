...
Backend: POST to http://localhost:8000/rag. Request fields: question string, mode one of auto/locate/flow/change, retrieval_mode one of dense/sparse/hybrid, limit 1-20, optional repository_path hidden in advanced settings. API base URL must be editable and default to http://localhost:8000.
