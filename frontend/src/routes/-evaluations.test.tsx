...
const populatedSummary: EvaluationDashboardSummary = {
  ...
  metric_averages: [
    { metric: "correctness", average_score: 4 },
    { metric: "groundedness", average_score: 5 },
    { metric: "citation_accuracy", average_score: 4.5 },
  ],
};
...
describe("Evaluations route", () => {
  ...
  it("renders persisted evaluation summary, charts, runs, and result rows", async () => {
    ...
    expect(screen.getByText("monitored runs")).toBeInTheDocument();
